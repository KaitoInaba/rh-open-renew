...
```
件名：Your Red Hat OPENTLC service provision request for OTLC-LAB-xxxxx-redhat.com-PROD_ELT_HANDS_ON_OPENSHIFT_410-xxxxx_COMPLETED has completed.
差出人：noreply@opentlc.com
本文：
Thank you for ordering Hands On with OpenShift 4.10
...
```
件名：Your Red Hat OPENTLC service OTLC-LAB-xxxxx-redhat.com-PROD_ELT_HANDS_ON_OPENSHIFT_410-xxxxxx_COMPLETED runtime extend request.
差出人：noreply@opentlc.com
本文：
